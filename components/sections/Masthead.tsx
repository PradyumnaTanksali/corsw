    ...
    <header className="relative pt-12 md:pt-20">
      ...
      <Container>
        ...
        {/* Fade is CSS (globals.css --animate-masthead-rise); motion-safe skips
            it under prefers-reduced-motion; paused while app/layout.tsx marks
            fonts pending. */}
        <h1 className="mt-16 max-w-[16ch] text-[clamp(2.5rem,7vw,5.5rem)] font-medium leading-[0.95] tracking-[-0.02em] text-balance motion-safe:animate-masthead-rise [.fonts-pending_&]:[animation-play-state:paused] md:mt-24">
